...
OMP_NUM_THREADS=8 taskset -c 0,1,2,3,4,5,6,7 \
./build/benchmarks/ocp-solve/Release/benchmark-ocp-solve \
    --benchmark_filter='bm_factor_new_kqt.*' \
    --benchmark_out=ocp-solve-N-new-kqt.json --benchmark_repetitions=5 --benchmark_min_time=0.05s \
    --N=256 --vary-N-pow-2 --step=1 --nx=40 --nu=20 --ny=0 --lP=8
OMP_NUM_THREADS=8 taskset -c 0,1,2,3,4,5,6,7 \
./build/benchmarks/ocp-solve/Release/benchmark-ocp-solve \
    --benchmark_filter='bm_factor_riccati_blasfeo.*' \
    --benchmark_out=ocp-solve-N-blasfeo.json --benchmark_repetitions=5 --benchmark_min_time=0.5s \
    --N=32 --vary-nx-frac --step=40 --nx=40 --nu=30 --ny=30
```
