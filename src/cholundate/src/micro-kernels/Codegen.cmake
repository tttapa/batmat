...
function(codegen_cholundate_microkernels tgt)
    ...
    if (KOQKATOO_WITH_LIBFORK)
        ...
        target_link_libraries(${tgt}-impl-householder-updowndate-libfork PRIVATE ${tgt} warnings)
    ...
    target_link_libraries(${tgt}-impl-householder-updowndate-static PRIVATE ${tgt} warnings)
