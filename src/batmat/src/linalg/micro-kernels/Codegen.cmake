    ...
    foreach(op "gemm")
        ...
        foreach(DType "float" "double")
            foreach(I 1 2 4 8 16)
                if (I EQUAL 16 AND DType STREQUAL "double")
                    continue()
                endif()
                set(simd_abi "deduce_t<${DType}, ${I}>")
                if (I EQUAL 1)
                    set(simd_abi "scalar")
                endif()
                configure_file("${CMAKE_CURRENT_FUNCTION_LIST_DIR}/${op}.cpp.in" "${OUT_DIR}/${op}-${DType}-${I}.cpp" @ONLY)
                target_sources(${tgt}-micro-kernels-${op} PRIVATE "${OUT_DIR}/${op}-${DType}-${I}.cpp")
            endforeach()
        endforeach()
    endforeach()
