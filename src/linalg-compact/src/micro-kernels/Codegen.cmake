function(codegen_compact_microkernels tgt)
    ...
    foreach(op "xgemm" "xgemm-diag" "xgemm-diag-mask" "xgemmt" "xgemmt-diag" "xgemmt-diag-mask" "xtrmm" "xtrsm" "xpotrf" "xpntrf" "xtrtri" "xshh" "xshhud")
        add_library(${tgt}-microkernels-${op} STATIC)
        target_link_libraries(${tgt}-microkernels-${op} PRIVATE ${tgt} warnings)
