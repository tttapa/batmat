...
[[gnu::always_inline]] inline stdx::simd_mask<T, Abi>
compare_ge_0(stdx::simd<T, Abi> x) {
...
gather(stdx::simd<T, AbiT> src, stdx::simd_mask<I, AbiI> mask,
       stdx::simd<I, AbiI> vindex, const T *base_addr) {
    return stdx::simd<T, AbiT>{
        [=](auto i) { return mask[i] ? base_addr[vindex[i]] : src[i]; }};
}

#if defined(__AVX512F__)

[[gnu::always_inline]] inline __mmask8 compare_ge_0(deduce_simd<int32_t, 4> x) {
    return _mm_cmp_epi32_mask(static_cast<__m128i>(x),
                              static_cast<__m128i>(decltype(x){}),
                              _MM_CMPINT_NLT);
}

[[gnu::always_inline]] inline __mmask8 compare_ge_0(deduce_simd<int32_t, 8> x) {
    return _mm256_cmp_epi32_mask(static_cast<__m256i>(x),
                                 static_cast<__m256i>(decltype(x){}),
                                 _MM_CMPINT_NLT);
}

[[gnu::always_inline]] inline __mmask16
compare_ge_0(deduce_simd<int32_t, 16> x) {
    return _mm512_cmp_epi32_mask(static_cast<__m512i>(x),
                                 static_cast<__m512i>(decltype(x){}),
                                 _MM_CMPINT_NLT);
}

[[gnu::always_inline]] inline __mmask8 compare_ge_0(deduce_simd<int64_t, 2> x) {
    return _mm_cmp_epi64_mask(static_cast<__m128i>(x),
                              static_cast<__m128i>(decltype(x){}),
                              _MM_CMPINT_NLT);
}
[[gnu::always_inline]] inline __mmask8 compare_ge_0(deduce_simd<int64_t, 4> x) {
    return _mm256_cmp_epi64_mask(static_cast<__m256i>(x),
                                 static_cast<__m256i>(decltype(x){}),
                                 _MM_CMPINT_NLT);
}

[[gnu::always_inline]] inline __mmask8 compare_ge_0(deduce_simd<int64_t, 8> x) {
    return _mm512_cmp_epi64_mask(static_cast<__m512i>(x),
                                 static_cast<__m512i>(decltype(x){}),
                                 _MM_CMPINT_NLT);
}
...
gather(deduce_simd<double, 8> src, __mmask8 mask,
       deduce_simd<int64_t, 8> vindex, const void *base_addr) {
    return deduce_simd<double, 8>{_mm512_mask_i64gather_pd(
        static_cast<__m512d>(src), mask, static_cast<__m512i>(vindex),
        base_addr, Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<double, 4>
gather(deduce_simd<double, 4> src, __mmask8 mask,
       deduce_simd<int64_t, 4> vindex, const void *base_addr) {
    return deduce_simd<double, 4>{_mm256_mmask_i64gather_pd(
        static_cast<__m256d>(src), mask, static_cast<__m256i>(vindex),
        base_addr, Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<double, 2>
gather(deduce_simd<double, 2> src, __mmask8 mask,
       deduce_simd<int64_t, 2> vindex, const void *base_addr) {
    return deduce_simd<double, 2>{
        _mm_mmask_i64gather_pd(static_cast<__m128d>(src), mask,
                               static_cast<__m128i>(vindex), base_addr, Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<double, 8>
gather(deduce_simd<double, 8> src, __mmask8 mask,
       deduce_simd<int32_t, 8> vindex, const void *base_addr) {
    return deduce_simd<double, 8>{_mm512_mask_i32gather_pd(
        static_cast<__m512d>(src), mask, static_cast<__m256i>(vindex),
        base_addr, Scale)};
}
...
[[gnu::always_inline]] inline deduce_simd<double, 4>
gather(deduce_simd<double, 4> src, __mmask8 mask,
       deduce_simd<int32_t, 4> vindex, const void *base_addr) {
    return deduce_simd<double, 4>{_mm256_mmask_i32gather_pd(
        static_cast<__m256d>(src), mask, static_cast<__m128i>(vindex),
        base_addr, Scale)};
}
...
[[gnu::always_inline]] inline deduce_simd<double, 2>
gather(deduce_simd<double, 2> src, __mmask8 mask,
       deduce_simd<int32_t, 2> vindex, const void *base_addr) {
    return deduce_simd<double, 2>{
        _mm_mmask_i32gather_pd(static_cast<__m128d>(src), mask,
                               static_cast<__m128i>(vindex), base_addr, Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 16>
gather(deduce_simd<float, 16> src, __mmask16 mask,
       deduce_simd<int32_t, 16> vindex, const void *base_addr) {
    return deduce_simd<float, 16>{_mm512_mask_i32gather_ps(
        static_cast<__m512>(src), mask, static_cast<__m512i>(vindex), base_addr,
        Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 8>
gather(deduce_simd<float, 8> src, __mmask8 mask, deduce_simd<int32_t, 8> vindex,
       const void *base_addr) {
    return deduce_simd<float, 8>{_mm256_mmask_i32gather_ps(
        static_cast<__m256>(src), mask, static_cast<__m256i>(vindex), base_addr,
        Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 4>
gather(deduce_simd<float, 4> src, __mmask8 mask, deduce_simd<int32_t, 4> vindex,
       const void *base_addr) {
    return deduce_simd<float, 4>{
        _mm_mmask_i32gather_ps(static_cast<__m128>(src), mask,
                               static_cast<__m128i>(vindex), base_addr, Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 8>
gather(deduce_simd<float, 8> src, __mmask8 mask, deduce_simd<int64_t, 8> vindex,
       const void *base_addr) {
    return deduce_simd<float, 8>{_mm512_mask_i64gather_ps(
        static_cast<__m256>(src), mask, static_cast<__m512i>(vindex), base_addr,
        Scale)};
}

template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 4>
gather(deduce_simd<float, 4> src, __mmask8 mask, deduce_simd<int64_t, 4> vindex,
       const void *base_addr) {
    return deduce_simd<float, 4>{_mm256_mmask_i64gather_ps(
        static_cast<__m128>(src), mask, static_cast<__m256i>(vindex), base_addr,
        Scale)};
}
...
template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 8>
gather(deduce_simd<float, 8> src, __m256i mask, deduce_simd<int32_t, 8> vindex,
    ...
    __m256 result      = _mm256_blendv_ps(static_cast<__m256>(src), gathered,
                                          _mm256_castsi256_ps(active));
...
gather(deduce_simd<double, 4> src, __m128i mask, deduce_simd<int32_t, 4> vindex,
    ...
    __m256d result =
        _mm256_blendv_pd(static_cast<__m256d>(src), gathered,
...
template <int Scale>
[[gnu::always_inline]] inline deduce_simd<float, 4>
gather(deduce_simd<float, 4> src, __m128i mask, deduce_simd<int32_t, 4> vindex,
       const float *base_addr) {
    __m128i active     = mask;
    __m128i safe_index = _mm_and_si128(static_cast<__m128i>(vindex), active);
    __m128 gathered    = _mm_i32gather_ps(base_addr, safe_index, Scale);
    __m128 result      = _mm_blendv_ps(static_cast<__m128>(src), gathered,
                                       _mm_castsi128_ps(active));
...
gather(deduce_simd<double, 2> src, __m128i mask, deduce_simd<int32_t, 2> vindex,
    ...
    __m128d result =
        _mm_blendv_pd(static_cast<__m128d>(src), gathered,
...
concept same_size_but_different_ints =
    std::integral<T1> && std::integral<T2> && sizeof(T1) == sizeof(T2) &&
    !std::same_as<T1, T2>;
...
deduce_simd<T, N> gather(const T *p, deduce_simd<I, N> idx) {
    if constexpr (detail::same_size_but_different_ints<I, int32_t>) {
        ...
        return detail::gather<sizeof(T)>(deduce_simd<T, N>{},
                                         detail::compare_ge_0(idx_), idx_, p);
