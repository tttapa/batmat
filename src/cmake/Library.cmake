...
function(koqkatoo_configure_visibility target)
...
add_library(koqkatoo::common_options ALIAS common_options)
...
function(koqkatoo_configure_library tgt)
    cmake_parse_arguments(KOQKATOO_CFG_LIB "" "EXPORT_PREFIX" "" ${ARGN})
    cmake_path(SET export_path "")
    set(name_prefix "")
    if (DEFINED KOQKATOO_CFG_LIB_EXPORT_PREFIX)
        cmake_path(APPEND export_path ${KOQKATOO_CFG_LIB_EXPORT_PREFIX})
        set(name_prefix "${KOQKATOO_CFG_LIB_EXPORT_PREFIX}-")
    endif()
    ...
    koqkatoo_configure_visibility(${tgt})
    target_compile_features(${tgt} PUBLIC cxx_std_20)
    if (KOQKATOO_WITH_CXX_23)
    ...
    target_link_libraries(${tgt} PRIVATE koqkatoo::warnings
                                 PUBLIC koqkatoo::common_options)
    add_library(koqkatoo::${tgt} ALIAS ${tgt})
endfunction()
...
function(koqkatoo_configure_interface_library tgt)
    ...
    target_link_libraries(${tgt} INTERFACE koqkatoo::common_options)
    add_library(koqkatoo::${tgt} ALIAS ${tgt})
endfunction()
